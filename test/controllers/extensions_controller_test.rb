...
class ExtensionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create extension" do
    assert_difference('Extension.count') do
      post extensions_url, params: { extension: { name: @extension.name, site: @extension.site, url: @extension.url } }
    end
  ...
  test "should update extension" do
    patch extension_url(@extension), params: { extension: { name: @extension.name, site: @extension.site, url: @extension.url } }
