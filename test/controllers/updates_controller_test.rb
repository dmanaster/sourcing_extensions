...
class UpdatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create update" do
    assert_difference('Update.count') do
      post updates_url, params: { update: { date: @update.date, extension_id: @update.extension_id, overview: @update.overview, version: @update.version } }
    end
  ...
  test "should update update" do
    patch update_url(@update), params: { update: { date: @update.date, extension_id: @update.extension_id, overview: @update.overview, version: @update.version } }
